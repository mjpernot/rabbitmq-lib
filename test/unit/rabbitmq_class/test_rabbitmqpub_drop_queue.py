...
"""Program:  test_rabbitmqpub_drop_queue.py
...
def rabbitmqpub_drop_queue(cfg):

    """Function:  rabbitmqpub_drop_queue

    Description:  Test drop_queue method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.drop_queue method unit testing...")
    rabbitmqpub_drop_queue(cfg)
