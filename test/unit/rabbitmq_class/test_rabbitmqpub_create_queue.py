...
"""Program:  test_rabbitmqpub_create_queue.py

    Description:  Does unit testing on RabbitMQPub.create_queue in
...
def rabbitmqpub_create_queue(cfg):

    """Function:  rabbitmqpub_create_queue

    Description:  Test create_queue method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.create_queue method testing...")
    rabbitmqpub_create_queue(cfg)
