...
"""Program:  test_rabbitmqpub_close_channel.py

    Description:  Does unit testing on RabbitMQPub.close_channel in
...
def rabbitmqpub_close_channel(cfg):

    """Function:  rabbitmqpub_close_channel

    Description:  Test close_channel method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.close_channel method testing...")
    rabbitmqpub_close_channel(cfg)
