...
"""Program:  test_rabbitmqpub_bind_queue.py

    Description:  Does unit testing on RabbitMQPub.bind_queue in
...
def rabbitmqpub_bind_queue(cfg):

    """Function:  rabbitmqpub_bind_queue

    Description:  Test bind_queue method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.bind_queue method testing...")
    rabbitmqpub_bind_queue(cfg)
