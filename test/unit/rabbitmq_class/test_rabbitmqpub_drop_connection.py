...
"""Program:  test_rabbitmqpub_drop_connection.py

    Description:  Does unit testing on RabbitMQPub.drop_connection in
...
def rabbitmqpub_drop_connection(cfg):

    """Function:  rabbitmqpub_drop_connection

    Description:  Test drop_connection method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.drop_connection method testing...")
    rabbitmqpub_drop_connection(cfg)
