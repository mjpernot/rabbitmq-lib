...
coverage run -a --source=rabbitmq_class test/unit/rabbitmq_class/rabbitmqpub_connect_queue.py
...
coverage run -a --source=rabbitmq_class test/unit/rabbitmq_class/rabbitmqpub_queue_count.py
...
coverage run -a --source=rabbitmq_class test/unit/rabbitmq_class/rabbitmqadmin_list_queues_for_vhost.py
