...
"""Program:  test_rabbitmqpub_open_channel.py

    Description:  Does unit testing on RabbitMQPub.open_channel in
...
def rabbitmqpub_open_channel(cfg):

    """Function:  rabbitmqpub_open_channel

    Description:  Test open_channel method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.open_channel method unit testing...")
    rabbitmqpub_open_channel(cfg)
