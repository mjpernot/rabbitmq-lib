...
"""Program:  rabbitmqadmin_list_extensions.py

    Description:  Unit testing of RabbitMQAdmin.list_extensions in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(self.rmq.list_extensions(), self.results)
