...
"""Program:  rabbitmqadmin_get_queue_for_vhost.py

    Description:  Unit testing of RabbitMQAdmin.get_queue_for_vhost in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(
            self.rmq.get_queue_for_vhost(self.vhost, self.qname), self.results)
