...
"""Program:  rabbitmqadmin_get_definitions.py

    Description:  Unit testing of RabbitMQAdmin.get_definitions in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(self.rmq.get_definitions(), self.results)
