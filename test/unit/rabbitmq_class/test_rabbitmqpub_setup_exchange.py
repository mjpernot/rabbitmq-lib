...
"""Program:  test_rabbitmqpub_setup_exchange.py

    Description:  Does unit testing on RabbitMQPub.setup_exchange in
...
def rabbitmqpub_setup_exchange(cfg):

    """Function:  rabbitmqpub_setup_exchange

    Description:  Test setup_exchange method in RabbitMQPub class.
        ...
        if isinstance(RQ.connection,
            ...
            if RQ.channel.is_open:
                ...
                try:
                    ...
                    print("\tFAILURE:  Exchange not found")
...
def main():
    ...
    print("\nRabbitMQPub.setup_exchange method testing...")
    rabbitmqpub_setup_exchange(cfg)
