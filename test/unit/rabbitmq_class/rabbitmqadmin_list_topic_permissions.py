...
"""Program:  rabbitmqadmin_list_topic_permissions.py

    Description:  Unit testing of RabbitMQAdmin.list_topic_permissions in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(self.rmq.list_topic_permissions(), self.results)
