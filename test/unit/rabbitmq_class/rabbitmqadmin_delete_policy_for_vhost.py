...
"""Program:  rabbitmqadmin_delete_policy_for_vhost.py

    Description:  Unit testing of RabbitMQAdmin.delete_policy_for_vhost in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_delete):
        ...
        self.assertFalse(
            self.rmq.delete_policy_for_vhost(self.pname, self.vhost))
