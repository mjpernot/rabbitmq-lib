...
"""Program:  test_rabbitmqpub_init.py

    Description:  Does unit testing on RabbitMQPub.__init__ in
...
def rabbitmqpub_init(cfg):

    """Function:  rabbitmqpub_init

    Description:  Test __init__ method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.__init__ method testing...")
    rabbitmqpub_init(cfg)
