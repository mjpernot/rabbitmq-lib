...
"""Program:  test_rabbitmqpub_check_confirm.py

    Description:  Does unit testing on RabbitMQPub.check_confirm in
...
def rabbitmqpub_check_confirm(cfg):

    """Function:  rabbitmqpub_check_confirm

    Description:  Test check_confirm method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.check_confirm method testing...")
    rabbitmqpub_check_confirm(cfg)
