...
"""Program:  rabbitmqadmin_overview.py

    Description:  Unit testing of RabbitMQAdmin.overview in rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(self.rmq.overview(), self.results)
