...
"""Program:  test_rabbitmqpub_publish_msg.py

    Description:  Does unit testing on RabbitMQPub.publish_msg in
...
def rabbitmqpub_publish_msg(cfg):

    """Function:  rabbitmqpub_publish_msg

    Description:  Test publish_msg method in RabbitMQPub class.
...
def main():
    ...
    print("\nRabbitMQPub.publish_msg method unit testing...")
    rabbitmqpub_publish_msg(cfg)
