...
"""Program:  rabbitmqadmin_list_connections.py

    Description:  Unit testing of RabbitMQAdmin.list_connections in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(self.rmq.list_connections(), self.results)
