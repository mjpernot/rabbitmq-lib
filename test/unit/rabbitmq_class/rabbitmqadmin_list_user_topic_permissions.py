...
"""Program:  rabbitmqadmin_list_user_topic_permissions.py

    Description:  Unit testing of RabbitMQAdmin.list_user_topic_permissions in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(
            self.rmq.list_user_topic_permissions(self.uname), self.results)
