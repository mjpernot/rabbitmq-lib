...
"""Program:  rabbitmqadmin_list_exchanges_for_vhost.py

    Description:  Unit testing of RabbitMQAdmin.list_exchanges_for_vhost in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(
            self.rmq.list_exchanges_for_vhost(self.vhost), self.results)
