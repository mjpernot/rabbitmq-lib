...
"""Program:  rabbitmqadmin_list_vhost_user_topic_perms.py

    Description:  Unit testing of RabbitMQAdmin.list_vhost_user_topic_perms in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(
            self.rmq.list_vhost_user_topic_perms(
