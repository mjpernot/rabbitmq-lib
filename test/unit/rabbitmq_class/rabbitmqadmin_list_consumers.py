...
"""Program:  rabbitmqadmin_list_consumers.py

    Description:  Unit testing of RabbitMQAdmin.list_consumers in
        rabbitmq_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_basic(self, mock_get):
        ...
        self.assertEqual(self.rmq.list_consumers(), self.results)
